...
namespace Catch {
    ...
    void AssertionHandler::complete() {
        m_completed = true;
        if ( m_reaction.shouldDebugBreak | m_reaction.shouldThrow |
             m_reaction.shouldSkip ) {
            if ( m_reaction.shouldDebugBreak ) {

                // If you find your debugger stopping you here then go one level
                // up on the call-stack for the code that caused it (typically a
                // failed assertion)
